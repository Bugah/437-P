package mc437.promocao.impl;

import java.util.*;import mc437.promocao.spec.prov.*;
...
class Manager implements IManager{
	...
	public String[] getProvidedInterfaces(){
	   ...
	   provInterfaceList.add("IPromocao");
	...
	public Object getProvidedInterface(String name){
	   ...
	   if (name.equals("IPromocao")){
	   		return new IPromocaoFacade();
	   }
